...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("fish-indent" "fprettify" "format-all-" "yapf" "terraform-fmt" "scalafmt" "shfmt" "snakefmt" "sqlformat" "swiftformat" "rufo" "rustfmt" "perltidy" "pgformatter" "prettier" "purty" "ocp-indent" "nixfmt" "mix-format" "latexindent" "ledger-mode" "lua-fmt" "ktlint" "jsonnetfmt" "istyle-verilog" "hindent" "html-tidy" "gleam" "gofmt" "elm-format" "emacs-lisp" "define-format-all-formatter" "dartfmt" "dfmt" "dhall" "dockfmt" "cabal-fmt" "cmake-format" "crystal" "beautysh" "bibtex-mode" "black" "brittany" "bsrefmt" "buildifier" "asmfmt")))
